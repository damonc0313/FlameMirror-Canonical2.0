...
.PHONY: help install test lint format clean build run dev docker-build docker-run docker-stop docker-clean docs security performance monitoring deploy production development
